...
def get_deep_args():
    ...
    parser.add_argument('--model_type', type=str, default=default_args['model_type'],
                        choices=[
                            ...
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_re',
                            ...
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_rcl_cl_tau_fixed_cl',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_rcl_fixed_cl',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_rcl_kernel_mlp_cl_tau',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_rcl_kernel_mlp_cl_tau_fixed_cl',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_rcl_cl_tau_re',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_cl_tau_blrm',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_cl_tau_cllrm',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_cl_tau_ens_drop',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_cl_tau_mcl',
                            ...
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_cl_tau_sigma_shared',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_cl_tau_wide',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_cl_tau_sep',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_mlp_2_clp_split',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_mlp_2_clp_split_cl_tau',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_mlp_2',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_uniform_B',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_pen_indep_mean_re_nocwd2_uniform_T',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_re_nocwd2_uniform_B',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifo_re_nocwd2_uniform_T',
                            ...
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_cl_tau_fixed_cl',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_fixed_cl',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_kernel_mlp_cl_tau',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_kernel_mlp_cl_tau_fixed_cl',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_cl_tau_re',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_cl_tau',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_cl_tau_sigma_shared',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_cl_tau_nocwd',
                            'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_cl_tau_sep',
                            ...
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_act_fn',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_act_fn_relu',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_act_fn_relu_ifo',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_act_fn_gelu',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_lapl',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_kernel_mode',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_mh',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_lh1',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_lh2',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_lh1_mnn',
                            'nwck_wd_nn_neurons_cl_params_b_params_fmask_no_re_rbp_re_right_range_lh2_mnn',
                            ...
                            'nwck_wd_nn_neurons_lin_nn_cl_params_b_params_fmask_no',
...
def get_method(model):
    ...
    # General methods
        ...
        'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_kernel_mlp_cl_tau',
        'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_kernel_mlp_cl_tau_fixed_cl',
        'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_kernel_mlp_fixed_cl',
        'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_cl_tau_re',
        'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_rcl_softplus',
        'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_cl_tau_nocwd',
        'nwck_wd_rerere_fmask_no_act_fn_relu_ifs_cl_tau_sep',
